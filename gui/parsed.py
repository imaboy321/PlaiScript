...
class Ui_ParseWindow(object):
    def setupUi(self, ParseWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(690, 330, 158, 71))
        self.horizontalLayoutWidget_2.setObjectName(_fromUtf8("horizontalLayoutWidget_2"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.btnParsedReset = QtGui.QPushButton(self.horizontalLayoutWidget_2)
        self.btnParsedReset.setObjectName(_fromUtf8("btnParsedReset"))
        self.horizontalLayout_2.addWidget(self.btnParsedReset)
    ...
    def retranslateUi(self, ParseWindow):
        ParseWindow.setWindowTitle(_translate("ParseWindow", "Guide", None))
        ...
        self.btnParsedReset.setText(_translate("ParseWindow", "Reset", None))
